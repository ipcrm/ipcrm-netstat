...
2. [Setup - The basics of getting started with netstat](#setup)
    * [What netstat affects](#what-netstat-affects)
    * [Setup requirements](#setup-requirements)
    * [Beginning with netstat](#beginning-with-netstat)
